...
func main() {
	...
	var vectorStore memory.VectorStore = memory.NewQdrantVectorStore("http://localhost:6333", "memories", embeddingService)
	var graphStore memory.GraphStore = memory.NewNeo4jGraphStore("http://localhost:7474", "neo4j", "password")
